return {
    ...
    after = function(plugin)
      ...
      vim.keymap.set("n", "<leader>cd", function() Snacks.explorer.open() end, { desc = 'Snacks file explorer' })
      vim.keymap.set("n", "<c-\\>", function() Snacks.terminal.toggle() end, { desc = 'Snacks Terminal' })
